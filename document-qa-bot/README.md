...
├── .env                          # Файл для хранения переменных окружения (например, OpenAI API Key)
├── n8n_document_qa_workflow.json # JSON-файл рабочего процесса n8n
├── python/
│   ├── process_document.py       # Скрипт для обработки PDF и создания базы FAISS
│   └── qa_handler.py             # Скрипт для обработки вопросов и получения ответов
└── README.md                     # Этот файл
